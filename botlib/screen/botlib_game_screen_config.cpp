                            ...
                            const std::string &configFile)
{
    ...
    std::vector<JsonParamPtr> params{
        ...
        jsonParam(hpProgressBarName, {"progressBars", "hp", "template"},
                  true, k_nonEmptyStrV),
        jsonParam(hpProgressBarMargin_, {"progressBars", "energy", "margin"}),
        ...
        jsonParam(navigatorBottomSpacing_, "navigatorBottomSpacing",
                  true, gt(0.0f)),
        jsonParam(navigatorLeftSpacing_, "navigatorLeftSpacing",
                  true, gt(0.0f)),
